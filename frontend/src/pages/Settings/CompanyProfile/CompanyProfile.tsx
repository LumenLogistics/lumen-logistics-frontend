...
const STORAGE_KEY = 'orbithaul-company-profile';
const LOGO_STORAGE_KEY = 'orbithaul-company-logo';
...
const CompanyProfile: React.FC = () => {
  ...
  const saveCompanyInfo = () => {
    ...
    window.localStorage.setItem('orbithaul-company-name', profile.companyInfo.name);
